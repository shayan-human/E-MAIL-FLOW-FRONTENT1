---
name: skill-creator
description: Generates high-quality, predictable, and efficient ".agent/skills/" directories based on user requirements. Use when the user wants to create a new skill, reference other skills, or add a capability to the agent.
---
