                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <div className="relative z-20" ref={subjectSlash.popupRef}>
                                            <Input
                                                ...
                                                className="text-base py-6 relative z-10"
                                                autoComplete="off"
                                            />
                                            {subjectSlash.activePopup && (
                                                <div className="absolute top-full left-0 mt-2 w-56 rounded-xl border shadow-xl z-30 overflow-hidden animate-in fade-in slide-in-from-top-2 duration-200" style={{ backgroundColor: "#141414", borderColor: "#222" }}>
                                                    ...
                                                    <div className="p-1 max-h-60 overflow-y-auto">
                                                        {subjectSlash.filteredOptions.map((option, idx) => (
                                                            <button
                                                                 ...
                                                                 className={`w-full text-left px-3 py-2 rounded-lg text-sm transition-colors flex items-center justify-between group ${idx === subjectSlash.selectedIndex ? 'bg-primary/10 text-primary' : 'text-zinc-300 hover:bg-zinc-800'}`}
                                                             >
                                                                 <span>{option.label}</span>
                                                                 <span className={`text-xs font-mono opacity-50 ${idx === subjectSlash.selectedIndex ? 'text-primary' : 'group-hover:text-zinc-400'}`}>{option.tag}</span>
                                                             </button>
                                                        ))}
                                                    </div>
                                                </div>
                                    ...
                                    <div className="space-y-2 flex-1 flex flex-col">
                                        ...
                                        <div className="relative z-20" ref={bodySlash.popupRef}>
                                            <Textarea
                                                ...
                                                className="flex-1 min-h-[300px] text-base leading-relaxed resize-none font-sans relative z-10"
                                            />
                                            {bodySlash.activePopup && (
                                                <div className="absolute top-8 left-2.5 w-64 rounded-xl border shadow-2xl z-30 overflow-hidden animate-in fade-in slide-in-from-top-2 duration-200" style={{ backgroundColor: "#141414", borderColor: "#222" }}>
                                                    <div className="px-3 py-2 border-b bg-muted/10 text-xs font-semibold text-muted-foreground uppercase tracking-wider" style={{ borderColor: "#222" }}>
                                                        Insert Personalization
                                                    </div>
                                                    <div className="p-1 max-h-60 overflow-y-auto">
                                                        {bodySlash.filteredOptions.map((option, idx) => (
                                                            <button
                                                                 ...
                                                                 className={`w-full text-left px-3 py-2 rounded-lg text-sm transition-colors flex items-center justify-between group ${idx === bodySlash.selectedIndex ? 'bg-primary/10 text-primary' : 'text-zinc-300 hover:bg-zinc-800'}`}
                                                             >
                                                                 <span>{option.label}</span>
                                                                 <span className={`text-xs font-mono opacity-50 ${idx === bodySlash.selectedIndex ? 'text-primary' : 'group-hover:text-zinc-400'}`}>{option.tag}</span>
                                                             </button>
                                                        ))}
                                                    </div>
                                                </div>
