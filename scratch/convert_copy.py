...
def convert_copy_to_insert(backup_file, output_dir, batch_size=100):
    ...
    with open(backup_file, 'r') as f:
        for line in f:
            ...
            if current_table:
                # This is a data line in a COPY block
...
if __name__ == "__main__":
    convert_copy_to_insert('emailflowbackupppp20260423_170122.sql', 'scratch/bulk_restored_inserts', 100)
