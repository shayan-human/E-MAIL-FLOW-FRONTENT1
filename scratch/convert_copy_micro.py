...
def convert_copy_to_insert(backup_file, output_dir, batch_size=10):
...
if __name__ == "__main__":
    convert_copy_to_insert('emailflowbackupppp20260423_170122.sql', 'scratch/micro_stable_inserts', 10)
